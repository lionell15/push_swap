...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/01 16:26:11 by lespinoz          #+#    #+#             */
/*   Updated: 2022/03/01 16:26:14 by lespinoz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	t_com **result, int len)
{
	...
	if (len_1 == 2 && (!(*stack1) || get_stack_len(*stack1) < 2))
		return ;
	else if (len_1 == 2 && (!(*stack2)
			|| get_stack_len(*stack2) < 2 || len_2 > 3))
	...
	else if (len_1 == 2 && len_2 == 3 && get_stack_len(*stack2) > 2)
	{
		swap_two(stack1, result);
	...
	t_com **result, int len)
{
	...
	if (len_1 > 3 && len_2 == 2)
		swap_two(stack2, result);
	else if (len_1 == 3 && (!(*stack1) || get_stack_len(*stack1) < 3))
		return ;
	else if (len_1 == 3 && (!(*stack2) || get_stack_len(*stack2) < 2
			|| len_2 > 3))
	...
	else if (len_1 == 3 && len_2 == 3 && get_stack_len(*stack2) > 2)
	{
		swap_three(stack1, result);
		swap_three(stack2, result);
	}
